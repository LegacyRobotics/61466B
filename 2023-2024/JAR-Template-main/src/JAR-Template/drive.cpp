...
void Drive::control_mech_arcade(){
  DriveRF.spin(fwd,to_volt((-controller(primary).Axis3.position() - (controller(primary).Axis4.position() +  controller(primary).Axis1.position()))),volt);
  DriveLF.spin(fwd,to_volt((-controller(primary).Axis3.position() + (controller(primary).Axis4.position() + controller(primary).Axis1.position()))),volt);
  DriveRB.spin(fwd,to_volt(-controller(primary).Axis3.position() + (controller(primary).Axis4.position() - controller(primary).Axis1.position())),volt);
  DriveLB.spin(fwd,to_volt(-controller(primary).Axis3.position() - (controller(primary).Axis4.position() - controller(primary).Axis1.position())),volt);
