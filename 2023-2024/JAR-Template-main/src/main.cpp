...
//Left Motors:
motor_group(Lfront,Lback),

//Right Motors:
motor_group(Rfront,Rback),
  ...
  while(auto_started == false){
    ...
    switch(current_auton_selection){
      case 0:
        ...
        Brain.Screen.printAt(150, 100, "No Auton Selected!");
        break;
      case 1:
        Brain.Screen.printAt(150, 100, "Left Auton");
        break;
      case 2:
        Brain.Screen.printAt(150, 100, "Right Auton");
        break;
      case 3:
        Brain.Screen.printAt(150, 100, "Full Auton");
        break;
      case 4:
...
void autonomous(void) {
  ...
  switch(current_auton_selection){  
    case 0:
      no_auton(); //This is the default auton, if you don't select from the brain.
      break;
    case 1:
      left_auton();
      break;
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    //Replace this line with chassis.control_tank(); for tank drive or chassis.control_arcade(); for arcade.
    chassis.control_mech_arcade();
